...
import com.example.images.Response;
import com.example.images.StorageService;
...
public class FileController {
    ...
    public ResponseEntity<Response> UrlDownload(@RequestParam String imageUrl) throws IOException {
        Response res = new Response();
        try{
            res.setMessage("done");
            res.setSuccess(true);
            storageService.getImageUrl(imageUrl);
